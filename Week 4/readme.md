...
This document summarizes the key concepts from the **C2_W1_Assignment.ipynb** notebook.
...
Would you like me to make this version formatted for **LaTeX-rendered display (for GitHub or Jupyter viewing)** so the equations show properly instead of raw markdown math?
